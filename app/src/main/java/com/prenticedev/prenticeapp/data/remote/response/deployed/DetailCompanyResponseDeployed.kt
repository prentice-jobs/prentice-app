...
data class DetailCompanyResponseDeployed(

	@field:SerializedName("data")
	val data: DetailCompanyData? = null,
...
data class DetailCompanyReviewItems(
...
data class DetailCompanyData(
	...
	val companyReviews: List<DetailCompanyReviewItems?>? = null,
